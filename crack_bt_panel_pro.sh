...
install_python_for_CentOS6() {
    py_for_centos="https://raw.githubusercontent.com/bestgu/SSR.Go/master/python_for_centos6.sh"
...
install_btPanel_for_CentOS() {
    yum install -y wget && wget -O install.sh https://raw.githubusercontent.com/bestgu/Crack_BT_Panel/master/install.sh && bash install.sh
    wget -O update.sh https://raw.githubusercontent.com/bestgu/Crack_BT_Panel/master/update_pro/update_pro.sh && bash update.sh pro
}

install_btPanel_for_APT() {
    wget -O install.sh https://raw.githubusercontent.com/bestgu/Crack_BT_Panel/master/install-ubuntu.sh && bash install.sh
    wget -O update.sh https://raw.githubusercontent.com/bestgu/Crack_BT_Panel/master/update_pro/update_pro.sh && bash update.sh pro
}
...
components(){
    cd /root
    wget -O lib.sh https://raw.githubusercontent.com/bestgu/Crack_BT_Panel/master/lib.sh
    mv lib.sh /www/server/panel/install
    wget -O nginx.sh https://raw.githubusercontent.com/bestgu/Crack_BT_Panel/master/nginx.sh
    mv nginx.sh /www/server/panel/install
    if [ -f /www/server/panel/install/install_soft.sh ]; then
        rm -rf install_soft.sh
        wget -O install_soft.sh https://raw.githubusercontent.com/bestgu/Crack_BT_Panel/master/install_soft.sh
...
vip_plugin(){
    ...
    if [ ! -d "/masterslave" ]; then
        wget -O vip_plugin.zip https://github.com/bestgu/Crack_BT_Panel/raw/master/update_pro/vip_plugin.zip
